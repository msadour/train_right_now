"""
Django settings for train_right_now project.
...
SECRET_KEY = 'django-insecure-%55^zfi7b^iu6nn$c+ta-2zz*m*5(or^=r74w)!j-n_b@)nhc$'
...
ROOT_URLCONF = 'train_right_now.urls'
...
WSGI_APPLICATION = 'train_right_now.wsgi.application'
